 ...
 * 
 * Discription:
 * This class is used to create a dialog box to save a canvas. This dialog box is used to get the width, height and scale of the canvas to be saved.
*/

public class SaveCanvas extends JDialog {
	...
	public SaveCanvas(JFrame parent, PixelCanvas canvas) {
		...
		okButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(validatePath(SaveCanvas.this.canvasSavePath))
				{
					SaveCanvas.this.closeOperationOption = APPROVE_OPTION;
					SaveCanvas.this.dispose();
				}else {
					JOptionPane.showMessageDialog(SaveCanvas.this, "Invalid Path.", "Saving Failed",
					        JOptionPane.ERROR_MESSAGE);
					SaveCanvas.this.closeOperationOption = CANCEL_OPTION;
					SaveCanvas.this.dispose();
				}
			}
		});
